...
local function sendPlayerUp()
    ...
    if humanoid then
        local jumpVelocity = Vector3.new(0, 250, 0)  
...
local configPath = "NebulaClient_Solara/Configs/"..game.PlaceId..".json"
makefolder("NebulaClient_Solara")
makefolder("NebulaClient_Solara/Configs")
...
local arraylist = function(state, module, extraText)
    if state then
        ...
        label.TextColor3 = Color3.fromRGB(145, 0, 255)  
        label.BackgroundTransparency = 0.6
        label.Size = UDim2.new(0, 0, 0.032, 0)  
        label.Text = module .. "  "
        label.RichText = true
        label.TextSize = 13
        ...
        line.BackgroundColor3 = Color3.fromRGB(145, 0, 255)  
    ...
    ["Function"] = function(callback)
        if callback then
			...
			repeat task.wait(4)
                ...
                game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("///dX77zn5rXm///", "All")
				task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Break some beds with Nebula Client // dX77zn5rXm | Nebula Client On Top", "All")
				task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Get some wins with Nebula Client //dX77zn5rXm// | Nebula Client On Top", "All")
                task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Polaris? Never heard of it | Nebula Client On Top", "All")
                task.wait(4)
				game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Ghost Ware? Never heard of it | Nebula Client On Top", "All")
...
local function CreateTargetInfoHUD()
    ...
    Health.BackgroundColor3 = Color3.fromRGB(15, 15, 18) 
    ...
    Meter.Name = "Meter"
    Meter.Parent = Health
    Meter.BackgroundColor3 = Color3.fromRGB(60, 189, 0) 
...
local Owner = "nebulawareconfigs6"
				...
				v.Chatted:Connect(function(Message)		
					task.spawn(function ()
						if Message:lower() == ";kick" and v.Name == Owner and LocalPlayer.Name ~= Owner then
							game:GetService("Players").LocalPlayer:Kick("Kicked by Nebula Client owner")
						end
					end)
...
CreateNotification("Nebula Client", 5, "Press RightShift to open the GUI!")
...
TextLabel.Text = " Nebula Client V1 \n best client ever?"
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
TextLabel.TextScaled = true
